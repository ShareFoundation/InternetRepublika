 ...
 */
class PostQuoteForm extends BasePostForm {
  ...
  public function configure() {
    ...
    $this->setValidators(array(
        ...
        'quote' => new sfValidatorString(array('max_length' => 250)),
        'quote_author' => new sfValidatorString(array('max_length' => 255, 'required' => true)),
        'tags' => new sfValidatorString(array('max_length' => 255, 'required' => false)),
    ));

    $this->getWidget('submited')->setDefault(1);

    $this->getWidgetSchema()->setLabels(array('text' => __('Comment'), 'title' => __('Title'), 'quote' => __('Quote'), 'quote_author' => __('Author')));
