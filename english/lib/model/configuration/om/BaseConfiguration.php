...
abstract class BaseConfiguration extends BaseObject  implements Persistent {
	...
	public function setCode($v)
	{
		...
		if ($this->code !== $v) {
			$this->code = $v;
			$this->modifiedColumns[] = ConfigurationPeer::CODE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = ConfigurationPeer::NUM_COLUMNS - ConfigurationPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ConfigurationPeer::CODE)) $criteria->add(ConfigurationPeer::CODE, $this->code);
