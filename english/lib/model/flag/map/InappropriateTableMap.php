...
/**
 * This class defines the structure of the 'inappropriate' table.
 *
 *
 ...
 */
class InappropriateTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.flag.map.InappropriateTableMap';
	...
	{
	  // attributes
		$this->setName('inappropriate');
		$this->setPhpName('Inappropriate');
		$this->setClassname('Inappropriate');
