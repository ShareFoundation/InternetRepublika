...
abstract class BaseNews extends BaseObject  implements Persistent {
	...
	public function setIsPublished($v)
	{
		...
		if ($this->is_published !== $v || $this->isNew()) {
			$this->is_published = $v;
			$this->modifiedColumns[] = NewsPeer::IS_PUBLISHED;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 7; // 7 = NewsPeer::NUM_COLUMNS - NewsPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NewsPeer::IS_PUBLISHED)) $criteria->add(NewsPeer::IS_PUBLISHED, $this->is_published);
