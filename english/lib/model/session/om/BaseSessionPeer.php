...
abstract class BaseSessionPeer {
	...
	const CLASS_DEFAULT = 'lib.model.session.Session';
	...
	/** the column name for the SESS_USER field */
	const SESS_USER = 'session.SESS_USER';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('SessId', 'SessData', 'SessTime', 'SessUser', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('sessId', 'sessData', 'sessTime', 'sessUser', ),
		BasePeer::TYPE_COLNAME => array (self::SESS_ID, self::SESS_DATA, self::SESS_TIME, self::SESS_USER, ),
		BasePeer::TYPE_FIELDNAME => array ('sess_id', 'sess_data', 'sess_time', 'sess_user', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('SessId' => 0, 'SessData' => 1, 'SessTime' => 2, 'SessUser' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('sessId' => 0, 'sessData' => 1, 'sessTime' => 2, 'sessUser' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::SESS_ID => 0, self::SESS_DATA => 1, self::SESS_TIME => 2, self::SESS_USER => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('sess_id' => 0, 'sess_data' => 1, 'sess_time' => 2, 'sess_user' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(SessionPeer::SESS_USER);
	}
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSessionPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseSessionPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSessionPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseSessionPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSessionPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseSessionPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSessionPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseSessionPeer', $values, $con, $ret);
    }
