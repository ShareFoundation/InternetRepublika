...
/**
 * This class defines the structure of the 'mg_content' table.
 *
 *
 ...
 *
 * @package    plugins.mgStaticPagePlugin.lib.model.map
 */
class ContentTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'plugins.mgStaticPagePlugin.lib.model.map.ContentTableMap';
	...
	{
	  // attributes
		$this->setName('mg_content');
		$this->setPhpName('Content');
		$this->setClassname('Content');
		$this->setPackage('plugins.mgStaticPagePlugin.lib.model');
