...
/**
 * Base class that represents a row from the 'mg_content' table.
 *
 * 
 *
...
abstract class BaseContent extends BaseObject  implements Persistent {
	...
	public function setLabel($v)
	{
		...
		if ($this->label !== $v) {
			$this->label = $v;
			$this->modifiedColumns[] = ContentPeer::LABEL;
		}
	...
	public function setIsPublished($v)
	{
		...
		if ($this->is_published !== $v) {
			$this->is_published = $v;
			$this->modifiedColumns[] = ContentPeer::IS_PUBLISHED;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 7; // 7 = ContentPeer::NUM_COLUMNS - ContentPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ContentPeer::LABEL)) $criteria->add(ContentPeer::LABEL, $this->label);
		...
		if ($this->isColumnModified(ContentPeer::IS_PUBLISHED)) $criteria->add(ContentPeer::IS_PUBLISHED, $this->is_published);
