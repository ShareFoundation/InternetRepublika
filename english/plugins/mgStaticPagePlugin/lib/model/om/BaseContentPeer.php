...
/**
 * Base static class for performing query and update operations on the 'mg_content' table.
 *
 * 
 *
...
abstract class BaseContentPeer {
	...
	const TABLE_NAME = 'mg_content';

	/** the related Propel class for this table */
	const OM_CLASS = 'Content';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'plugins.mgStaticPagePlugin.lib.model.Content';
	...
	const ID = 'mg_content.ID';

	/** the column name for the LABEL field */
	const LABEL = 'mg_content.LABEL';

	/** the column name for the TITLE field */
	const TITLE = 'mg_content.TITLE';

	/** the column name for the TEXT field */
	const TEXT = 'mg_content.TEXT';

	/** the column name for the IS_PUBLISHED field */
	const IS_PUBLISHED = 'mg_content.IS_PUBLISHED';

	/** the column name for the CREATED_AT field */
	const CREATED_AT = 'mg_content.CREATED_AT';

	/** the column name for the UPDATED_AT field */
	const UPDATED_AT = 'mg_content.UPDATED_AT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Label', 'Title', 'Text', 'IsPublished', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'label', 'title', 'text', 'isPublished', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::LABEL, self::TITLE, self::TEXT, self::IS_PUBLISHED, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'label', 'title', 'text', 'is_published', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Label' => 1, 'Title' => 2, 'Text' => 3, 'IsPublished' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'label' => 1, 'title' => 2, 'text' => 3, 'isPublished' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::LABEL => 1, self::TITLE => 2, self::TEXT => 3, self::IS_PUBLISHED => 4, self::CREATED_AT => 5, self::UPDATED_AT => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'label' => 1, 'title' => 2, 'text' => 3, 'is_published' => 4, 'created_at' => 5, 'updated_at' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ContentPeer::LABEL);
		$criteria->addSelectColumn(ContentPeer::TITLE);
		$criteria->addSelectColumn(ContentPeer::TEXT);
		$criteria->addSelectColumn(ContentPeer::IS_PUBLISHED);
	...
	/**
	 * Method to invalidate the instance pool of all tables related to mg_content
	...
	/**
	 * Method to DELETE all rows from the mg_content table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
