...
abstract class BasesfGuardUserPeer {
	...
	public static function clearRelatedInstancePool()
	{
		...
		// invalidate objects in InappropriateCommentPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
		InappropriateCommentPeer::clearInstancePool();

		// invalidate objects in PartiePeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(PostBadgePeer::USER_ID, $obj->getId());
			...
			$criteria->add(InappropriatePeer::USER_ID, $obj->getId());
			$affectedRows += InappropriatePeer::doDelete($criteria, $con);

			// delete related InappropriateComment objects
			$criteria = new Criteria(InappropriateCommentPeer::DATABASE_NAME);
			
			$criteria->add(InappropriateCommentPeer::USER_ID, $obj->getId());
			$affectedRows += InappropriateCommentPeer::doDelete($criteria, $con);

			// delete related Partie objects
			$criteria = new Criteria(PartiePeer::DATABASE_NAME);
			
			$criteria->add(PartiePeer::USER_ID, $obj->getId());
			$affectedRows += PartiePeer::doDelete($criteria, $con);

			// delete related PostPollVote objects
			$criteria = new Criteria(PostPollVotePeer::DATABASE_NAME);
			
			$criteria->add(PostPollVotePeer::USER_ID, $obj->getId());
			...
			$criteria->add(PostVisitsPeer::USER_ID, $obj->getId());
			...
			$criteria->add(PartieVisitsPeer::USER_ID, $obj->getId());
			...
			$criteria->add(PartieCustomPointsPeer::USER_ID, $obj->getId());
