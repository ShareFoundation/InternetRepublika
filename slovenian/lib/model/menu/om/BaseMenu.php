...
abstract class BaseMenu extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the order_position field.
	...
	/**
	 * The value for the is_target_blank field.
	 * Note: this column has a database default value of: false
	 * @var        boolean
	 */
	protected $is_target_blank;
	 ...
	 * Note: this column has a database default value of: 'all'
	 * @var        string
	 */
	protected $language;
	...
	/**
	 * Get the [order_position] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Get the [is_target_blank] column value.
	 * 
	 * @return     boolean
	 */
	...
	/**
	 * Set the value of [order_position] column.
	 * 
	 * @param      int $v new value
	 * @return     Menu The current object (for fluent API support)
	 */
	public function setOrderPosition($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->order_position !== $v || $this->isNew()) {
			$this->order_position = $v;
			$this->modifiedColumns[] = MenuPeer::ORDER_POSITION;
		}
	...
	public function setIsEnabled($v)
	{
		...
		if ($this->is_enabled !== $v || $this->isNew()) {
			$this->is_enabled = $v;
			$this->modifiedColumns[] = MenuPeer::IS_ENABLED;
		}
	...
	/**
	 * Set the value of [is_target_blank] column.
	 * 
	 * @param      boolean $v new value
	 * @return     Menu The current object (for fluent API support)
	 */
	public function setIsTargetBlank($v)
	{
		if ($v !== null) {
			$v = (boolean) $v;
		}

		if ($this->is_target_blank !== $v || $this->isNew()) {
			$this->is_target_blank = $v;
			$this->modifiedColumns[] = MenuPeer::IS_TARGET_BLANK;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->order_position = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->is_enabled = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
			$this->is_target_blank = ($row[$startcol + 5] !== null) ? (boolean) $row[$startcol + 5] : null;
			...
			return $startcol + 10; // 10 = MenuPeer::NUM_COLUMNS - MenuPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 2:
				...
				break;
			case 3:
				return $this->getOrderPosition();
				break;
			case 4:
				return $this->getIsEnabled();
				break;
			case 5:
				return $this->getIsTargetBlank();
				break;
			case 6:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[2] => $this->getLink(),
			$keys[3] => $this->getOrderPosition(),
			$keys[4] => $this->getIsEnabled(),
			$keys[5] => $this->getIsTargetBlank(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 2:
				...
				break;
			case 3:
				$this->setOrderPosition($value);
				break;
			case 4:
				$this->setIsEnabled($value);
				break;
			case 5:
				$this->setIsTargetBlank($value);
				break;
			case 6:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setOrderPosition($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setIsEnabled($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setIsTargetBlank($arr[$keys[5]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MenuPeer::ORDER_POSITION)) $criteria->add(MenuPeer::ORDER_POSITION, $this->order_position);
		if ($this->isColumnModified(MenuPeer::IS_ENABLED)) $criteria->add(MenuPeer::IS_ENABLED, $this->is_enabled);
		if ($this->isColumnModified(MenuPeer::IS_TARGET_BLANK)) $criteria->add(MenuPeer::IS_TARGET_BLANK, $this->is_target_blank);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setOrderPosition($this->order_position);

		$copyObj->setIsEnabled($this->is_enabled);

		$copyObj->setIsTargetBlank($this->is_target_blank);
