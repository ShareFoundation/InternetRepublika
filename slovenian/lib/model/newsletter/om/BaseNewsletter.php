...
abstract class BaseNewsletter extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the is_subscribed field.
	...
	/**
	 * Get the [is_subscribed] column value.
	 * 
	 * @return     boolean
	 */
	...
	public function setFirstName($v)
	{
		...
		if ($this->first_name !== $v) {
			$this->first_name = $v;
			$this->modifiedColumns[] = NewsletterPeer::FIRST_NAME;
		}
	...
	public function setLastName($v)
	{
		...
		if ($this->last_name !== $v) {
			$this->last_name = $v;
			$this->modifiedColumns[] = NewsletterPeer::LAST_NAME;
		}
	...
	/**
	 * Set the value of [is_subscribed] column.
	 * 
	...
	public function setIsSubscribed($v)
	{
		...
		if ($this->is_subscribed !== $v || $this->isNew()) {
			$this->is_subscribed = $v;
			$this->modifiedColumns[] = NewsletterPeer::IS_SUBSCRIBED;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->is_subscribed = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
			...
			return $startcol + 7; // 7 = NewsletterPeer::NUM_COLUMNS - NewsletterPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseNewsletter:delete:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseNewsletter:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseNewsletter:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseNewsletter:save:post') as $callable)
				{
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setIsSubscribed($arr[$keys[4]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NewsletterPeer::FIRST_NAME)) $criteria->add(NewsletterPeer::FIRST_NAME, $this->first_name);
		if ($this->isColumnModified(NewsletterPeer::LAST_NAME)) $criteria->add(NewsletterPeer::LAST_NAME, $this->last_name);
		if ($this->isColumnModified(NewsletterPeer::IS_SUBSCRIBED)) $criteria->add(NewsletterPeer::IS_SUBSCRIBED, $this->is_subscribed);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIsSubscribed($this->is_subscribed);
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseNewsletter:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseNewsletter::%s', $method));
	  }
