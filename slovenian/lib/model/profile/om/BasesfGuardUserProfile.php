...
abstract class BasesfGuardUserProfile extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the is_email_comfirmed field.
	 * Note: this column has a database default value of: false
	 * @var        boolean
	 */
	protected $is_email_comfirmed;
	...
	/**
	 * The value for the is_first_login field.
	...
	/**
	 * Get the [is_email_comfirmed] column value.
	 * 
	 * @return     boolean
	 */
	public function getIsEmailComfirmed()
	{
		return $this->is_email_comfirmed;
	}
	...
	/**
	 * Get the [is_first_login] column value.
	 * 
	 * @return     boolean
	 */
	...
	public function setImageUrl($v)
	{
		...
		if ($this->image_url !== $v) {
			$this->image_url = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::IMAGE_URL;
		}
	...
	/**
	 * Set the value of [is_email_comfirmed] column.
	 * 
	 * @param      boolean $v new value
	 * @return     sfGuardUserProfile The current object (for fluent API support)
	 */
	public function setIsEmailComfirmed($v)
	{
		if ($v !== null) {
			$v = (boolean) $v;
		}

		if ($this->is_email_comfirmed !== $v || $this->isNew()) {
			$this->is_email_comfirmed = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::IS_EMAIL_COMFIRMED;
		}
	...
	public function setLastIp($v)
	{
		...
		if ($this->last_ip !== $v || $this->isNew()) {
			$this->last_ip = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::LAST_IP;
		}
	...
	/**
	 * Set the value of [is_first_login] column.
	 * 
	 * @param      boolean $v new value
	 * @return     sfGuardUserProfile The current object (for fluent API support)
	 */
	public function setIsFirstLogin($v)
	{
		if ($v !== null) {
			$v = (boolean) $v;
		}

		if ($this->is_first_login !== $v || $this->isNew()) {
			$this->is_first_login = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::IS_FIRST_LOGIN;
		}
	...
	{
			if ($this->is_email_comfirmed !== false) {
				return false;
			}

			if ($this->last_ip !== '0.0.0.0') {
				return false;
			}

			if ($this->is_first_login !== true) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->email_hash = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			...
			$this->image_url = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->is_email_comfirmed = ($row[$startcol + 7] !== null) ? (boolean) $row[$startcol + 7] : null;
			$this->last_ip = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->is_first_login = ($row[$startcol + 9] !== null) ? (boolean) $row[$startcol + 9] : null;
			$this->resetModified();
			...
			return $startcol + 10; // 10 = sfGuardUserProfilePeer::NUM_COLUMNS - sfGuardUserProfilePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 6:
				...
				break;
			case 7:
				return $this->getIsEmailComfirmed();
				break;
			case 8:
				return $this->getLastIp();
				break;
			case 9:
				return $this->getIsFirstLogin();
				break;
			default:
				return null;
				break;
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 6:
				...
				break;
			case 7:
				$this->setIsEmailComfirmed($value);
				break;
			case 8:
				$this->setLastIp($value);
				break;
			case 9:
				$this->setIsFirstLogin($value);
				break;
		} // switch()
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setEmailHash($arr[$keys[3]]);
		...
		if (array_key_exists($keys[7], $arr)) $this->setIsEmailComfirmed($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setLastIp($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setIsFirstLogin($arr[$keys[9]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfGuardUserProfilePeer::IMAGE_URL)) $criteria->add(sfGuardUserProfilePeer::IMAGE_URL, $this->image_url);
		if ($this->isColumnModified(sfGuardUserProfilePeer::IS_EMAIL_COMFIRMED)) $criteria->add(sfGuardUserProfilePeer::IS_EMAIL_COMFIRMED, $this->is_email_comfirmed);
		if ($this->isColumnModified(sfGuardUserProfilePeer::LAST_IP)) $criteria->add(sfGuardUserProfilePeer::LAST_IP, $this->last_ip);
		if ($this->isColumnModified(sfGuardUserProfilePeer::IS_FIRST_LOGIN)) $criteria->add(sfGuardUserProfilePeer::IS_FIRST_LOGIN, $this->is_first_login);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIsEmailComfirmed($this->is_email_comfirmed);

		$copyObj->setLastIp($this->last_ip);

		$copyObj->setIsFirstLogin($this->is_first_login);
