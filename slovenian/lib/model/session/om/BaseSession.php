...
abstract class BaseSession extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the sess_user field.
	 * @var        int
	 */
	protected $sess_user;
	...
	/**
	 * Get the [sess_user] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Set the value of [sess_user] column.
	 * 
	 * @param      int $v new value
	 * @return     Session The current object (for fluent API support)
	 */
	public function setSessUser($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}
		...
		if ($this->sess_user !== $v) {
			$this->sess_user = $v;
			$this->modifiedColumns[] = SessionPeer::SESS_USER;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->sess_user = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->resetModified();
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setSessUser($arr[$keys[3]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SessionPeer::SESS_USER)) $criteria->add(SessionPeer::SESS_USER, $this->sess_user);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setSessUser($this->sess_user);
